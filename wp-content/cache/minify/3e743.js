...
func();}}};function countdown_wpdevart_timer(main_div_id){var days_left=parseInt(jQuery('#'+main_div_id+' .days').text());var hours_left=parseInt(jQuery('#'+main_div_id+' .hourse').text());;var minutes_left=parseInt(jQuery('#'+main_div_id+' .minutes').text());;var secondes_left=parseInt(jQuery('#'+main_div_id+' .secondes').text());var all_time=days_left*24*3600+hours_left*3600+minutes_left*60+secondes_left;all_time--;days_left=parseInt(all_time/(3600*24));hours_left=parseInt((all_time-days_left*3600*24)/(3600));minutes_left=parseInt((all_time-days_left*3600*24-hours_left*3600)/(60));secondes_left=parseInt((all_time-days_left*3600*24-hours_left*3600-minutes_left*60));if((""+days_left+"").length>1)
